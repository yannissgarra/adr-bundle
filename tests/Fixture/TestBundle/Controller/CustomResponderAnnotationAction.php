 ...
 *
 * @Route("/custom-responder-annotation-action")
 * @Template("base.html.twig")
 */
final class CustomResponderAnnotationAction extends AbstractAction
{
    public const ROUTE_URI = '/custom-responder-annotation-action';
